...
<div class="card border-0 shadow-sm" style="max-width: 760px;">
    <div class="card-header bg-white border-bottom py-3">
        <h6 class="mb-0 fw-semibold"><i class="bi bi-plus-circle me-2"></i>New Service</h6>
    </div>
    <div class="card-body p-4">
        <form method="POST" action="{{ route('municipality.services.store', absolute: false) }}">
            @csrf
            @include('municipality.partials.service-form', ['service' => null, 'offices' => $offices])
            <div class="d-flex gap-2 mt-4">
                <button type="submit" class="btn btn-primary px-4">
                    <i class="bi bi-floppy me-2"></i>Create Service
                </button>
