...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="bg-white p-8 rounded-xl shadow-md w-full max-w-md">
        ...
        <p class="text-gray-500 mb-6">Login to your citizen account. You will complete two-factor authentication next.</p>
        ...
        <form method="POST" action="{{ route('citizen.login.store') }}">
            ...
            <div class="mt-4 flex items-center justify-between">
                ...
                @if (Route::has('citizen.password.request'))
                    <a href="{{ route('citizen.password.request') }}" class="text-sm text-indigo-600 hover:underline">
                        Forgot password?
                    </a>
                @endif
            </div>
        ...
        <p class="mt-6 text-center text-sm text-gray-600">
            ...
            <a href="{{ route('citizen.register') }}" class="text-indigo-600 hover:underline font-medium">Sign up</a>
        </p>
